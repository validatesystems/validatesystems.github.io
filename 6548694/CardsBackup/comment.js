...
const GAS_ENDPOINT = 'https://script.google.com/macros/s/AKfycbynOH0KTJpO5xFV-vtVsN34PyA3qRAZiPXyACIjtUEpjE8YcBs4N3y7SSPvROK5jOI4gw/exec';
const EXPECTED_SECRET_COMMENTS = "990143";
    ...
    btn.addEventListener('click', async () => {
        ...
        openCommentModal({
            ...
            onSend: async (comment, { done, stopSpinnerOnly }) => {
                ...
                const payload = {
                    secret: EXPECTED_SECRET_COMMENTS,
                    ts,
